  ...
  return (
    <>
      <div className="pt-3 pr-3 pl-3">
        <div className="card flex justify-content-between mb-2 border-solid">
            ...
            <div className="block">
              ...
              >
                <div className="cart gap-1">
                  ...
                  <Button label="หาจากหมวดหมู่สินค้า" />
                </div>
              </Sidebar>
            </div>
      ...
      <div className="navmenu w-full border-solid mb-1">
        ...
        <Sidebar
          ...
          <Button label="หมวดหมู่" icon="pi pi-chevron-down" iconPos="right" onClick={() => setVisible4(true)} />
        </div>
        <div>
          <a href="#">จัดเต็มความคุ้ม แม็คโครโปรพอยท์</a>
        </div>
        <div>
          <Sidebar
          ...
          >
            <div>
              ...
              <div className="box-menu mt-5"><a href="#">ลดแรง จัดหนัก</a></div>
              <div className="box-menu mt-5"><a href="#">โฮเรก้า</a></div>
              <div className="box-menu mt-5"><a href="#">มิตรแท้โชห่วย</a></div>
            </div>
          </Sidebar>
